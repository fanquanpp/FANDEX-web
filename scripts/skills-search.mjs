...
const LOCAL_SKILLS = [
  // 流程规范型（强遵循类）
  { name: 'pdf', category: 'document', type: 'strong', description: 'PDF 文件读取、合并、拆分、OCR' },
  ...
  { name: 'mermaid-diagrams', category: 'diagram', type: 'strong', description: 'Mermaid 图表生成' },
  { name: 'mermaid-studio', category: 'diagram', type: 'strong', description: 'Mermaid 图表专业渲染' },
  ...
  { name: 'tailwind-css-v4', category: 'frontend', type: 'strong', description: 'Tailwind CSS v4 模式' },
  { name: 'tailwind-v4', category: 'frontend', type: 'strong', description: 'Tailwind v4 迁移指南' },
  { name: 'tailwind-4', category: 'frontend', type: 'strong', description: 'Tailwind 4 模式与最佳实践' },
  { name: 'tailwind-patterns', category: 'frontend', type: 'strong', description: 'Tailwind v4 原则' },
  { name: 'tailwind-design-system', category: 'frontend', type: 'strong', description: '基于 Tailwind 的设计系统' },
  ...
  { name: 'astro-developer', category: 'frontend', type: 'strong', description: 'Astro monorepo 开发' },
  { name: 'astro-pr-writer', category: 'frontend', type: 'strong', description: 'Astro PR 写作' },
  { name: 'astro-starlight', category: 'frontend', type: 'strong', description: 'Astro Starlight 文档主题' },
  { name: 'astro-static-implementation', category: 'frontend', type: 'strong', description: 'Astro 静态实现' },
  { name: 'vue', category: 'frontend', type: 'strong', description: 'Vue 3 Composition API' },
  { name: 'vue-best-practices', category: 'frontend', type: 'strong', description: 'Vue.js 最佳实践' },
  ...
  { name: 'vueuse-functions', category: 'frontend', type: 'strong', description: 'VueUse 组合式函数' },
  { name: 'typescript', category: 'language', type: 'strong', description: 'TypeScript 风格指南' },
  { name: 'typescript-pro', category: 'language', type: 'strong', description: 'TypeScript 高级类型' },
  { name: 'typescript-expert', category: 'language', type: 'strong', description: 'TypeScript 严格类型' },
  { name: 'typescript-advanced-types', category: 'language', type: 'strong', description: 'TypeScript 高级类型系统' },
  { name: 'typescript-write', category: 'language', type: 'strong', description: 'TypeScript 编码标准' },
  { name: 'typescript-review', category: 'language', type: 'strong', description: 'TypeScript 代码审查' },
  { name: 'java-pro', category: 'language', type: 'strong', description: 'Java 21+ 现代特性' },
  { name: 'java-spring-framework', category: 'language', type: 'strong', description: 'Spring Boot 4 架构' },
  { name: 'kotlin-patterns', category: 'language', type: 'strong', description: 'Kotlin 惯用模式' },
  { name: 'kotlin-coroutines-flows', category: 'language', type: 'strong', description: 'Kotlin 协程与 Flow' },
  { name: 'kotlin-testing', category: 'language', type: 'strong', description: 'Kotlin 测试模式' },
  { name: 'dignified-python', category: 'language', type: 'strong', description: 'Python 生产编码标准' },
  { name: 'springboot-patterns', category: 'language', type: 'strong', description: 'Spring Boot 架构模式' },
  ...
  { name: 'academic-paper-polish', category: 'research', type: 'weak', description: '学术英文润色' },
  { name: 'academic-paper-review', category: 'research', type: 'weak', description: '学术论文评审' },
  { name: 'academic-poster-generator', category: 'research', type: 'weak', description: '学术海报生成' },
  ...
  { name: 'academic-writing-style', category: 'research', type: 'weak', description: '学术写作风格' },
  { name: 'research-lit', category: 'research', type: 'weak', description: '文献检索与分析' },
  { name: 'scientific-brainstorming', category: 'research', type: 'weak', description: '科学研究头脑风暴' },
  { name: 'scientific-problem-selection', category: 'research', type: 'weak', description: '科学问题选择' },
  ...
  { name: 'market-research-reports', category: 'research', type: 'weak', description: '市场研究报告' },
  ...
  { name: 'markdown-mermaid-writing', category: 'doc', type: 'strong', description: 'Markdown + Mermaid 写作' },
  ...
  { name: 'document-converter-suite', category: 'doc', type: 'strong', description: '文档转换套件' },
  { name: 'kami', category: 'doc', type: 'strong', description: '文档排版' },

  // 测试与质量型
  { name: 'tdd', category: 'test', type: 'strong', description: '测试驱动开发' },
  { name: 'test-driven-development', category: 'test', type: 'strong', description: 'TDD 红-绿-重构' },
  ...
  { name: 'husky-test-coverage', category: 'tooling', type: 'strong', description: 'Husky 测试覆盖率钩子' },
  { name: 'setup-pre-commit', category: 'tooling', type: 'strong', description: 'Pre-commit 钩子配置' },
  { name: 'eslint', category: 'tooling', type: 'strong', description: 'ESLint 配置' },
  { name: 'eslint-configuration', category: 'tooling', type: 'strong', description: 'ESLint 配置文件' },
  ...
  { name: 'prettier-configuration', category: 'tooling', type: 'strong', description: 'Prettier 配置' },
  { name: 'prettier-integration', category: 'tooling', type: 'strong', description: 'Prettier 集成' },
  ...
  { name: 'github-actions-creator', category: 'tooling', type: 'strong', description: 'GitHub Actions 创建' },
  { name: 'github-actions-hardening', category: 'tooling', type: 'strong', description: 'GitHub Actions 加固' },
  { name: 'github-actions-templates', category: 'tooling', type: 'strong', description: 'GitHub Actions 模板' },
  { name: 'github-actions-efficiency', category: 'tooling', type: 'strong', description: 'GitHub Actions 效率' },
  { name: 'github-actions-runtime-upgrade-conventions', category: 'tooling', type: 'strong', description: 'GitHub Actions 运行时升级' },
  ...
  { name: 'security-best-practices', category: 'arch', type: 'strong', description: '安全最佳实践' },
  ...
  { name: 'pagefind-static-low-bandwidth-search-engine', category: 'web', type: 'strong', description: 'Pagefind 静态搜索引擎' },
  ...
  { name: 'tauri-project-setup', category: 'desktop', type: 'strong', description: 'Tauri 项目初始化' },
  ...
  { name: 'electron-development', category: 'desktop', type: 'strong', description: 'Electron 开发' },
  { name: 'electron-pro', category: 'desktop', type: 'strong', description: 'Electron 专家' },
  { name: 'electron-chromium-upgrade', category: 'desktop', type: 'weak', description: 'Chromium 升级' },
  ...
  { name: 'android-accessibility', category: 'mobile', type: 'strong', description: 'Android 无障碍' },
  { name: 'android-clean-architecture', category: 'mobile', type: 'strong', description: 'Android Clean Architecture' },
  { name: 'android-e2e-testing', category: 'mobile', type: 'weak', description: 'Android E2E 测试' },
  { name: 'android-native-dev', category: 'mobile', type: 'strong', description: 'Android 原生开发' },
  ...
  { name: 'jetpack-compose-audit', category: 'mobile', type: 'strong', description: 'Compose 审计' },
  { name: 'jetpack-compose-dev', category: 'mobile', type: 'strong', description: 'Compose 开发' },
  { name: 'jetpack-compose-m3', category: 'mobile', type: 'strong', description: 'Wear OS Compose M3' },
  { name: 'jetpack-compose-patterns', category: 'mobile', type: 'strong', description: 'Compose 模式' },
  ...
  { name: 'analytics-data-analysis', category: 'data', type: 'strong', description: 'Python 数据分析' },
  ...
  { name: 'notion-infographic', category: 'image', type: 'strong', description: 'Notion 风格信息图' },
  ...
  { name: 'baoyu-format-markdown', category: 'doc', type: 'strong', description: 'Markdown 格式化' },
  { name: 'baoyu-markdown-to-html', category: 'doc', type: 'strong', description: 'Markdown 转 HTML' },
  { name: 'baoyu-danger-gemini-web', category: 'image', type: 'weak', description: 'Gemini 图像生成' },
  ...
  { name: 'video-subtitles-and-audio-insert-workflow', category: 'media', type: 'weak', description: '字幕与音频插入' },
  { name: 'video-storytelling-core-principles', category: 'media', type: 'strong', description: '视频叙事原则' },
  ...
  { name: 'hyperframes-media', category: 'media', type: 'weak', description: 'HyperFrames 媒体处理' },
  { name: 'hyperframes-registry', category: 'media', type: 'weak', description: 'HyperFrames 注册表' },
  ...
  { name: 'pptx-html-fidelity-audit', category: 'media', type: 'weak', description: 'PPT HTML 保真审计' },
  ...
  { name: 'byted-bp-cdn-pagesdeploy', category: 'deploy', type: 'weak', description: 'BytePlus CDN 部署' },
  ...
  { name: 'alibabacloud-data-agent-skill', category: 'cloud', type: 'weak', description: '阿里云 Data Agent' },
  { name: 'alibabacloud-bailian-rag-knowledgebase', category: 'cloud', type: 'weak', description: '百炼 RAG 知识库' },
  { name: 'alibabacloud-find-skills', category: 'meta', type: 'strong', description: '阿里云 Skill 搜索' },
  ...
  { name: 'lingxi-realtimemarketdata-skill', category: 'finance', type: 'weak', description: '灵犀实时行情' },
  { name: 'lingxi-researchreport-skill', category: 'finance', type: 'weak', description: '灵犀研报' },
  { name: 'lingxi-smartstockselection-skill', category: 'finance', type: 'weak', description: '灵犀选股' },
  ...
  { name: 'a-share-paper-trading-v2', category: 'finance', type: 'weak', description: 'A 股模拟交易' },
  ...
  { name: 'tailored-resume-generator', category: 'career', type: 'strong', description: '简历生成' },
  ...
  { name: 'browser-max-automation', category: 'browser', type: 'weak', description: 'Playwright 自动化' },
  ...
  { name: 'local-realtime-translator', category: 'local', type: 'weak', description: '本地实时翻译' },
  ...
  { name: 'notion-knowledge-capture', category: 'km', type: 'strong', description: 'Notion 知识捕获' },
  { name: 'notion-meeting-intelligence', category: 'km', type: 'strong', description: 'Notion 会议智能' },
  { name: 'notion-research-documentation', category: 'km', type: 'strong', description: 'Notion 研究文档' },
  { name: 'notion-spec-to-implementation', category: 'km', type: 'strong', description: 'Notion 规格转实现' },
  ...
  { name: 'install-skill-dependency', category: 'meta', type: 'weak', description: 'Skill 依赖安装' },
  ...
  { name: 'Getting Started with Skills', category: 'meta', type: 'strong', description: 'Skills 入门' },
  ...
  { name: 'competitive-ads-extractor', category: 'marketing', type: 'weak', description: '竞争对手广告提取' },
  { name: 'competitor-content-tracker', category: 'marketing', type: 'weak', description: '竞争对手内容追踪' },
  { name: 'social-media-strategy', category: 'marketing', type: 'strong', description: '社交媒体策略' },
  ...
  { name: 'pitch-deck-framework', category: 'marketing', type: 'strong', description: 'Pitch Deck 框架' },
  { name: 'internal-comms', category: 'marketing', type: 'strong', description: 'B2B 邮件写作' },
  { name: 'domain-name-brainstormer', category: 'marketing', type: 'strong', description: '域名头脑风暴' },
  ...
  { name: 'quickbi-smartq-chat', category: 'analytics', type: 'weak', description: 'Quick BI 智能分析' },
  { name: 'alipay-payment-integration', category: 'pay', type: 'weak', description: '支付宝集成' },
  { name: 'douyinpay-payment-integration', category: 'pay', type: 'weak', description: '抖音支付集成' },
  { name: 'douyin-interact-creation', category: 'media', type: 'weak', description: '抖音互动创作' },
  { name: 'douyin-interactive-content-publish', category: 'media', type: 'weak', description: '抖音互动发布' },
  { name: 'byted-seedance-video-generate', category: 'media', type: 'weak', description: 'Seedance 视频生成' },
  { name: 'byted-seedream-image-generate', category: 'media', type: 'weak', description: 'Seedream 图像生成' },
  { name: 'byted-mediakit-shared', category: 'media', type: 'weak', description: 'BytePlus MediaKit' },
  ...
  { name: 'TRAE-product-knowledge', category: 'meta', type: 'strong', description: 'TRAE 产品知识' },
  { name: 'Code Review Reception', category: 'arch', type: 'strong', description: '代码审查反馈接收' },
  ...
  { name: 'ui-prototype-prompt-generator', category: 'web', type: 'strong', description: 'UI 原型提示生成' },
  { name: 'ui-ux-pro-max', category: 'web', type: 'strong', description: 'UI/UX 设计智能' },
  { name: 'vercel-composition-patterns', category: 'arch', type: 'strong', description: 'React 组合模式' },
  { name: 'vercel-react-best-practices', category: 'web', type: 'strong', description: 'Vercel React 最佳实践' },
  { name: 'vercel-react-native-skills', category: 'mobile', type: 'strong', description: 'React Native 最佳实践' },
  ...
  { name: 'notebooklm-research', category: 'research', type: 'weak', description: 'NotebookLM 研究' },
  ...
  { name: 'gradle-build-performance', category: 'mobile', type: 'weak', description: 'Gradle 性能' },
...
async function searchRemote(query, limit, env) {
  ...
  try {
    ...
    const results = Array.isArray(data.results) ? data.results : (Array.isArray(data.skills) ? data.skills : []);
...
async function main() {
  ...
  console.log(`  [ENV] SKILLSMP_API_BASE: ${env.SKILLSMP_API_BASE || 'https://skillsmp.com/api/v1 (默认)'}`);
  ...
  if (args.listLocal) {
    ...
    for (const [category, skills] of Object.entries(grouped).sort()) {
      ...
      for (const skill of skills) {
        console.log(`  [${skill.type === 'strong' ? '强' : '弱'}] ${skill.name} — ${skill.description}`);
      }
      console.log('');
    }
    return;
