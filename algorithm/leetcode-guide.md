...
> 跨模块引用：各专题的详细算法参见 [[algorithm/overview|算法分析基础]] 及子章节。
...
> 跨模块引用：各算法专题的详细分析参见 [[algorithm/sorting|排序算法]]、[[algorithm/searching|搜索算法]]、[[algorithm/dynamic-programming|动态规划]]、[[algorithm/greedy|贪心算法]]、[[algorithm/graph|图论算法]]、[[algorithm/linked-list|链表]]、[[algorithm/tree|树结构]]、[[algorithm/hashtable|哈希表]]。语言基础参见 [[cpp/overview|C++基础]] 和 [[python/overview|Python基础]]。