...
很多零基础学习者在面对计算机科学时，往往不知道从哪里开始、该学什么、按什么顺序学。FANDEX 通过系统化的知识组织和前置知识链路，为学习者铺设一条从零到本科毕业的完整路径。

**核心理念：**

- 零基础友好：不假设任何编程经验，从环境搭建和 Markdown 写作起步
...
FANDEX-web 是 FANDEX 知识体系的**线上学习平台**。它是一份面向零基础学习者的计算机科学自学教程，以网页形式提供完整的在线学习体验。
...
| 仓库                                                  | 定位             | 特色                                                                                                  |
| :---------------------------------------------------- | :--------------- | :---------------------------------------------------------------------------------------------------- |
| [FANDEX-exe](https://github.com/fanquanpp/FANDEX-exe) | Windows 桌面端   | Electron 桌面应用，完全离线访问，适配网页端不具备的特殊功能，内置静态服务器，独立桌面应用            |
