...
**数学分析深化**：
- Rudin, W. (1987). *Real and Complex Analysis* (3rd ed.). McGraw-Hill. —— 测度论视角下的微分与积分，介绍 Lebesgue 微分定理、Radon-Nikodym 导数。
...
**自动微分与深度学习**：
- Goodfellow, I., Bengio, Y., & Courville, A. (2016). *Deep Learning*. MIT Press. —— 深度学习权威教材，第 6 章系统介绍反向传播与计算图。
