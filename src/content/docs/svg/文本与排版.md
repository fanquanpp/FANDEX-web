...
<svg viewBox="0 0 300 150">
  <!-- 描边文字 -->
  <text x="20" y="40" font-size="32" fill="none" stroke="#4f5bd5" stroke-width="1.5">
    描边文字
  </text>
  <!-- 双层：先描边后填充 -->
  <text x="20" y="90" font-size="32" stroke="#fff" stroke-width="6" fill="#4f5bd5"
...
<svg viewBox="0 0 300 100" role="img" aria-labelledby="chart-title">
  ...
  <text x="150" y="50" text-anchor="middle" font-size="20" aria-hidden="true">
    销售额柱状图
  </text>
</svg>
```
