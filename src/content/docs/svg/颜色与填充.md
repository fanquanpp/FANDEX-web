...
```html
<polyline points="10,90 50,10 90,90" stroke="#000" stroke-width="10"
          fill="none" stroke-linejoin="miter" stroke-miterlimit="2" />
...
```html
<text font-size="40" stroke="#fff" stroke-width="6" fill="#4f5bd5"
...
<svg viewBox="0 0 200 60">
  ...
  <rect x="2" y="2" width="196" height="56" rx="28"
        fill="none" stroke="url(#btn-grad)" stroke-width="2"
        vector-effect="non-scaling-stroke" />
